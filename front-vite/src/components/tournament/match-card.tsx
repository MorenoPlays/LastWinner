...
export function MatchCard({ match, compact = false, className }: MatchCardProps) {
  ...
  return (
    <div className={cn('group overflow-hidden rounded-[1rem] border border-border bg-card/80 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:shadow-md', compact ? 'p-4' : 'p-5', className)}>
